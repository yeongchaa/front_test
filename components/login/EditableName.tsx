...
const EditableName: React.FC = () => {
  ...
  return (
    <div>
      <div
        className={`pt-[25px] pb-[12px] border-b ${
          isEditing ? "border-black" : "border-[#ebebeb]"
        }`}
      >
        {/* 이름 제목 */}
        ...
        <div className="flex items-center justify-between">
          ...
          {isEditing ? (
            ...
            <div className="py-2 pr-[58px] text-sm">{name}</div>
          )}
          {/* 버튼 */}
          {isEditing ? (
            <div className="flex space-x-1">
              ...
              <button
                ...
                className="text-[12px] text-[#ffffff] bg-black px-[14px] h-[34px] border rounded-[10px]"
              >
                저장
              </button>
            </div>
